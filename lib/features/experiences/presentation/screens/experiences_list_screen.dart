...
class _ExperiencesListScreenState extends State<ExperiencesListScreen>
  ...
  Widget _buildBody(ExperienceProvider provider) {
    ...
    // Layout tipo Instagram: Stories arriba, publicaciones abajo a€” todo en un scroll
  ...
  AdvertisementEntity _createMockAdvertisement(int index) {
    final advertisements = [
      ...
      AdvertisementEntity(
        ...
        description:
            'Ãšnete a nuestras rodadas semanales y conoce ciclistas de tu zona',
        imageUrl:
  ...
  // MÃ‰TODOS COMENTADOS - Ya no se crean publicaciones generales
  /*
              ...
              child: Row(
                children: [
                  ...
                  if (advertisement.advertiserName != null) ...[
                    ...
                    Text(
                      'a€¢ ${advertisement.advertiserName}',
                      style: TextStyle(
                        fontSize: 11,
