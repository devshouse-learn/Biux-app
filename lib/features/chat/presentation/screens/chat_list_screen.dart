                  ...
                  itemBuilder: (context, i) {
                    ...
                    return FutureBuilder<Map<String, dynamic>>(
                      ...
                      builder: (context, userSnap) {
                        ...
                        final name = isGroup
                            ? l.t('group_chat')
                            : (userData['name'] as String? ?? l.t('cyclist'));
