          ...
          child: ElevatedButton(
            ...
            onPressed: () async {
              if (form.currentState!.validate()) {
                ...
                try {
                  debugPrint('dŸ“ Iniciando actualización de perfil...');
                  await bloc.uploadUpdate(context);
                  debugPrint('aœ… Perfil actualizado, cerrando pantalla...');
                  ...
                  debugPrint('aŒ Excepción capturada: $e');
                  if (context.mounted) {
                    messenger.showSnackBar(
                      SnackBarUtils.customSnackBar(
                        content:
                ...
                debugPrint('aš ï¸ Formulario inválido');
