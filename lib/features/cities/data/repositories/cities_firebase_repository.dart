...
class CitiesFirebaseRepository extends CitiesRepositoryAbstract {
  ...
  Future<List<City>> getCities() async {
    try {
      ...
      AppLogger.debug(
        'Ciudades encontradas: ${result.docs.length}',
  ...
  Future<City> getSpecifiCities(int id) async {
    try {
      ...
      if (result.docs.isEmpty) {
        AppLogger.warning('Ciudad no encontrada: $id', tag: 'CitiesRepository');
        return City();
      }
      ...
      AppLogger.error(
        'Error obteniendo ciudad específica: $e',
        tag: 'CitiesRepository',
        error: e,
      );
      return City();
