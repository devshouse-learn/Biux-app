...
class RideTrackerProvider with ChangeNotifier {
  ...
  /// â€¢ Recorta la porción ya transitada de la ruta.
  /// â€¢ Si el ciclista se desvía â‰¥ 50 m, recalcula.
    ...
    _posSub =
        Geolocator.getPositionStream(
          locationSettings: const LocationSettings(
            ...
            // Solo emite si el dispositivo se movió â‰¥ 10 m reales
          ...
          (pos) {
            ...
            if (_points.isNotEmpty) {
              ...
              // pos.speed â‰ˆ 0 cuando el dispositivo está quieto (aunque GPS fluctÃºe).
              if (pos.speed >= 0.84) {
                // 0.84 m/s â‰ˆ 3 km/h
                final last = _points.last;
                final segKm = _calcDist(last.lat, last.lng, pt.lat, pt.lng);

                // FILTRO 3: Segmento mínimo de 8 m â€” ignora jitter residual
                // FILTRO 4: Segmento máximo de 300 m â€” evita saltos por pérdida de señal
