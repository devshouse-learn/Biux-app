...
class _RideTrackerScreenState extends State<RideTrackerScreen>
    ...
    if (p.points.length > 1) {
      markers.add(
        Marker(
          ...
          infoWindow: InfoWindow(title: l.t('start_point')),
        ),
      );
    }
    if (p.plannedRoute.isNotEmpty) {
      markers.add(
        Marker(
          ...
          infoWindow: InfoWindow(
            title: p.plannedDestinationName ?? l.t('destination'),
          ),
        ),
      );
    }
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      p.isPaused
                          ? l.t('paused').toUpperCase()
                          : l.t('recording').toUpperCase(),
                      style: const TextStyle(
                        color: Colors.white,
                        fontSize: 12,
                        fontWeight: FontWeight.w700,
  ...
  Widget _buildRouteFab(RideTrackerProvider p) {
    ...
    return FloatingActionButton.extended(
      ...
      label: Text(
        hasRoute ? l.t('active_route') : l.t('plan_route'),
            ...
            child: ElevatedButton(
              ...
              child: Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 6),
                  Text(
                    p.isPaused ? l.t('resume') : l.t('pause'),
                    style: const TextStyle(
                      fontSize: 14,
                      fontWeight: FontWeight.w700,
                    ),
  ...
  Widget _buildHistorySummary(RideTrackerProvider p) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          Text(
            '${p.history.length} ${l.t('registered_rides')}',
