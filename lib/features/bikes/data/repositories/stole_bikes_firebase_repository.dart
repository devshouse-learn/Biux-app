...
class StoleBikesFirebaseRepository extends StoleBikesRepositoryAbstract {
  ...
  Future<List<StoleBikes>> getBike() async {
    try {
      ...
      AppLogger.debug(
        'Bicicletas robadas encontradas: ${response.docs.length}',
      ...
      AppLogger.error(
        'Error obteniendo bicicletas robadas: $e',
        tag: 'StoleBikesRepository',
        error: e,
      );
      return [];
      ...
      AppLogger.error(
        'Error inesperado obteniendo bicicletas: $e',
        tag: 'StoleBikesRepository',
        error: e,
      );
      return [];
  ...
  Future<StoleBikes> getStoleBikes(String id) async {
    try {
      ...
      if (response.docs.isEmpty) {
        AppLogger.warning(
          'Bicicleta robada no encontrada: $id',
          tag: 'StoleBikesRepository',
        );
        return StoleBikes();
      }
      ...
      AppLogger.error(
        'Error obteniendo bicicleta robada: $e',
        tag: 'StoleBikesRepository',
        error: e,
      );
      return StoleBikes();
  ...
  Future createDatesStoleBikes(StoleBikes stoleBikes) async {
    try {
      ...
      AppLogger.error(
        'Error creando bicicleta robada: $e',
        tag: 'StoleBikesRepository',
        error: e,
      );
      rethrow;
  ...
  Future updateDatesStoleBikes(StoleBikes stoleBikes) async {
    try {
      ...
      AppLogger.info(
        'Bicicleta robada actualizada: ${stoleBikes.id}',
        tag: 'StoleBikesRepository',
      );
    } on ValidationException catch (e) {
      AppLogger.warning(
      ...
      AppLogger.error(
        'Error actualizando bicicleta robada: $e',
        tag: 'StoleBikesRepository',
        error: e,
      );
      rethrow;
