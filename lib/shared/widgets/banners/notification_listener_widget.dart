...
class _BiuxNotificationListenerState extends State<BiuxNotificationListener> {
    ...
    _notificationService.notificationStream.listen((data) {
      ...
      if (!isOpened) {
        ...
        try {
          ...
          debugPrint('aš ï¸ Error mostrando snackbar de notificación: $e');
        }
      } else {
  ...
  void _showNotificationSnackbar(Map<String, dynamic> data) {
    ...
    if (scaffoldMessenger == null) {
      debugPrint(
        'aš ï¸ No hay ScaffoldMessenger disponible para mostrar notificación',
      );
      return;
    }
  ...
  void _handleNotificationTap(Map<String, dynamic> data) {
    ...
    switch (type) {
      ...
      default:
        ...
        debugPrint('aš ï¸ Tipo de notificación desconocido: $type');
        context.push('/notifications');
    }
  }
