...
/// Realiza la llamada real a Google Directions API y decodifica
/// las polylines para renderizar la ruta en el mapa.
Future<DirectionsResult?> getDirectionsWithDetails({
